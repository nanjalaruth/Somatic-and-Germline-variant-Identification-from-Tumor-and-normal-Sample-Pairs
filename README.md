...
1. Galaxy Workflow:
- @Rachael - Adding genetic and clinical evidence-based annotations [galaxy workflow](https://usegalaxy.eu/u/rachael-eo/w/workflow-constructed-from-history-genomics-twoarachael-1)
- @Mercy
- @Orinda
- @Heshica
- @Kauthar
...
- @NadaaHussienn - Quality Control and Check [Link to Galaxy Workflow](https://usegalaxy.eu/u/nadahussien/h/identification-of-somatic-and-germline-variants-from-tumor-and-normal-sample-pairs)
- @Christabel
